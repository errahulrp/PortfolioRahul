            ...
            <div className='sm:hidden bg-[#121212] px-8 pt-8 pb-10 '>
                ...
                <div className={` fixed z-50 bg-[#121212] w-full h-[330px] -ml-11  ${menu === 'close' ? 'hidden' : ''}`}>
                    <ul className={`  text-white text-xl font-Bellefair px-10 pt-8   ${menu === 'close' ? 'hidden' : ''}`}>
                        <li className='cursor-pointer' onClick={() => handleOnClick('close')}> <a href="#AboutMe">About Me</a></li>
                        <li className=' mt-3 cursor-pointer' onClick={() => handleOnClick('close')}><a href="#Experience"> Experience</a></li>
                        <li className=' mt-3 cursor-pointer' onClick={() => handleOnClick('close')}><a href="#Education">Education</a></li>
                        <li className=' mt-3 cursor-pointer' onClick={() => handleOnClick('close')}><a href="#Projects">Projects</a></li>
                        <li className=' mt-3 cursor-pointer' onClick={() => handleOnClick('close')}><a href="#Skills">Skills</a></li>
                        <li className=' mt-3 cursor-pointer' onClick={() => handleOnClick('close')}><a href="#Contact">Contact</a></li>
                    </ul>
                </div>
            </div>
            <div className=''>
